...
const UpperContent = () => {
    ...
    return (
        <div className='flex items-center justify-between gap-5 '>
            ...
            <div>
                <div className='rounded-full p-1 inline-block' onClick={() => setIsClicked(!isClicked)}>
                    <div className='indicator cursor-pointer'>
                        ...
                        {!isClicked ?<span className='badge badge-xs badge-error indicator-item'></span> : null}
                    </div>
