...
const Notification = () => {
  return (
    <div className="bg-transparent w-[300px] h-[300px] rounded-md text-white absolute top-0 right-0 z-50">
...
<div id="toast-notification" className="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300  " role="alert">
    ...
    <div className="flex items-center">
        <div className="relative inline-block shrink-0">
            <span className="absolute bottom-0 -right-1.5 inline-flex items-center justify-center w-6 h-6 bg-blue-600 rounded-full">
        ...
        <div className="ms-3 text-sm font-normal">
            <div className="text-sm font-semibold text-gray-900 dark:text-white">Hello</div>
            <div className="text-sm font-normal">Welcome to our weather site</div> 
